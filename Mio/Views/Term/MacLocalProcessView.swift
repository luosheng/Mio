...
public protocol MacLocalProcessTerminalViewDelegate: AnyObject {
  /**
 ...
 */
public class MacLocalProcessTerminalView: TerminalView, TerminalViewDelegate, LocalProcessDelegate {
   ...
   */
  public weak var processDelegate: MacLocalProcessTerminalViewDelegate?
  ...
  public func getWindowSize () -> winsize
  {
    ...
    return winsize(ws_row: UInt16(t.rows), ws_col: UInt16(t.cols), ws_xpixel: UInt16 (f.width), ws_ypixel: UInt16 (f.height))
  }
